  ...
  $.fn.equalize = function(options) {
    ...
    return $containers.each(function() {
      ...
      $children.each(function() {
        ...
        if (margin && type == 'height') {
            var botMargin = $element.find('> :last').css('marginBottom').replace('px', '');

            if (!isNaN(botMargin)) {
                value += parseInt(botMargin);
            }

        } // include the bottom margin from the last child of this element in the height
